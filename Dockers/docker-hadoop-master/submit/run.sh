...
hadoop fs -mkdir -p hdfs://namenode:9000/user/mdt/input-data
...
hadoop jar $HADOOP_HOME/share/hadoop/tools/lib/hadoop-streaming-$HADOOP_VERSION.jar \
    ...
    -input hdfs://namenode:9000/user/mdt/input-data/daily.csv \
    -output hdfs://namenode:9000/user/mdt/output-data

hadoop fs -cat hdfs://namenode:9000/user/mdt/output-data/*
